    ...
    sticky top-0 z-20 bg-white dark:bg-gray-900'>
      ...
      >
        ...
        <img
          ...
          alt=''
          className='w-4 absolute right-4 top-4 sm:hidden cursor-pointer'
        ...
        <a onClick={() => setSidebarOpen(false)} href='#service' className='sm:hover:border-b'>
          Service
        </a>
      ...
      <div className='flex items-center gap-2 sm:gap-4'>
        ...
        <a
          href='#contact-us'
          className='text-sm max-sm:hidden flex items-center gap-2 bg-blue-800 hover:bg-blue-600 text-white px-6 py-2
